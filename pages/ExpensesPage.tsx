  ...
  return (
    <div className="relative min-h-screen bg-slate-50 pb-20">
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-6 space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as ExpenseTab)} className="w-full">
          <TabsList className="bg-white border border-slate-200 shadow-sm mb-6">
            <TabsTrigger
              value="categoria"
              className={
                activeTab === "categoria" ? "data-[state=active]:bg-[#02b1c4] data-[state=active]:text-white" : ""
              }
            >
            ...
            <TabsTrigger
              value="proveedor"
              className={
                activeTab === "proveedor" ? "data-[state=active]:bg-[#02b1c4] data-[state=active]:text-white" : ""
              }
            >
                      ...
                      return (
                        <div key={cat.tag_name} className="p-3 bg-slate-50 rounded-lg">
                          ...
                          <div className="flex items-center gap-4 text-xs text-slate-500">
                            ...
                            <span className="text-[#49eada]">Pagado: {formatCurrency(cat.pagado)}</span>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <select
                    ...
                    className="px-3 py-2 border border-slate-200 rounded-lg text-sm min-w-[200px] bg-white focus:outline-none focus:ring-2 focus:ring-[#17c3b2] focus:border-transparent"
                  >
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <select
                    ...
                    onChange={(e) => setProviderStatusFilter(e.target.value as ProviderStatusFilter)}
                    className="px-3 py-2 border border-slate-200 rounded-lg text-sm min-w-[160px] bg-white focus:outline-none focus:ring-2 focus:ring-[#17c3b2] focus:border-transparent"
                  >
                    <option value="all">Todos</option>
                    <option value="partial">Pagado</option>
                    ...
                    return (
                      <div key={provider.proveedor} className="p-3 bg-slate-50 rounded-lg">
                          ...
                          <div className="flex items-center gap-2">
                            <span
                              className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${
                                index === 0
                                  ? "bg-[#49eada]/20 text-[#49eada]"
                                  : index === 1
                                    ? "bg-slate-200 text-slate-600"
                                    : index === 2
                                      ? "bg-[#ffcb77]/20 text-[#ffcb77]"
                        ...
                        <div className="flex items-center gap-4 text-xs text-slate-500">
                          ...
                          <span className="text-[#49eada]">Pagado: {formatCurrency(provider.pagado)}</span>
