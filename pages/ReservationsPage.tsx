...
const YEAR_COLORS: Record<number, string> = {
  2021: "#94a3b8", // gris
  2022: BRAND_COLORS.lunch, // amarillo
  2023: BRAND_COLORS.error, // coral/rojo
  2024: BRAND_COLORS.accent, // azul
  2025: BRAND_COLORS.primary, // turquesa principal
  2026: "#8b5cf6", // violeta (futuro)
  2027: "#f59e0b", // naranja (futuro)
}
...
const ReservationsPage: React.FC = () => {
  ...
  const [dateRange, setDateRange] = useState<DateRange>(() => {
    ...
    console.log(
      "[v0] ReservationsPage init - businessToday:",
  ...
  return (
    <div className="relative min-h-screen bg-slate-50 pb-20">
      <PageHeader
        ...
        subtitle={`Visión unificada de demanda y eficiencia: ${getRangeLabel()}`}
        actions={
          <>
      ...
      <PageContent>
        ...
        <AIInsightCard context="Análisis de Ocupación y Reservas" data={insightData} />
