          ...
          <TremorCard>
            ...
            <div className="space-y-4">
              ...
              <Slider
                ...
                min={10}
                max={referenceData.capacidad_dia}
                step={5}
                className="w-full"
              />
              <div className="flex justify-between text-xs text-slate-400">
                ...
                <span>{referenceData.capacidad_dia}</span>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <TremorCard>
              <div className="text-center py-6">
                ...
                <div
                  className="mt-6 inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-bold"
                  style={{
                    backgroundColor:
                      calculations.difference >= 0 ? `${BRAND_COLORS.success}20` : `${BRAND_COLORS.error}20`,
                    color: calculations.difference >= 0 ? BRAND_COLORS.success : BRAND_COLORS.error,
                  }}
                >
                  ...
                  <span>
                    {calculations.difference >= 0 ? "+" : ""}
                    {formatCurrency(calculations.difference)} vs tu media
                  </span>
