...
export const MenuBar = React.forwardRef<HTMLDivElement, MenuBarProps>(
  ({ className, items, activeItem, onItemClick, ...props }, ref) => {
    ...
    // Helper para extraer el color hex del iconColor
    const getHexColor = (iconColor: string) => {
      const match = iconColor.match(/#[a-fA-F0-9]{6}/)
      return match ? match[0] : "#02b1c4"
    }
                ...
                >
                  ...
                  >
                    <motion.div
                      ...
                      animate={showGlow ? "hover" : "initial"}
                      style={{
                    ...
                    >
                      <span
                        ...
                        style={showColor ? { color: hexColor } : undefined}
                      >
