...
export function PageHeader({ icon: Icon, title, subtitle, actions }: PageHeaderProps) {
  // En móvil el header no es sticky: se va con el scroll y libera pantalla
  return (
    <div className="bg-white border-b border-slate-200 md:sticky md:top-0 z-30">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-2.5 md:py-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 md:gap-4">
          ...
          <div className="flex items-center flex-wrap gap-2 sm:gap-3 md:gap-4 md:justify-end min-w-0">
            {actions}
            {/* Campana de notificaciones solo en escritorio */}
